...
class TodoHeader extends React.Component {
  constructor(props){
    ...
    render () {
    return <input type="text" style={{marginLeft:"150px"}} className="ma2 b f2 pa3 b-- black gold tc" value={this.state.header} placeholder="--Edit title--" onChange={(e)=>{this.setState({header:e.target.value})}} />;
  }
}
...
class TodoApp extends React.Component {
  constructor (props) {
    ...
    this.state = {todoItems: this.props.fetchInitialData};
  }
